 ...
 * its {@link ClickArgumentResolver} resolves from the click. The shape is decided once per button at
 * boot, then applied per click — so the binding is a first-class value rather than an {@code
