 ...
 *
 * <p>{@code slots} holds the item for every inventory slot (content, border and navigation),
 * {@code null} for empty slots. {@code actions} holds the click action per content slot,
 * {@code null} elsewhere — these come straight from the provider, never the cache.
 *
...
public record RenderedPage(
    PageNumber page, ItemStack[] slots, MenuAction[] actions, boolean hasPrevious, boolean hasNext) {}
